...
def on_on_overlap3(sprite3, otherSprite3):
    Charli.set_flag(SpriteFlag.GHOST, False)
    Delta.set_flag(SpriteFlag.GHOST, False)
    cibo.set_position(0, 0)
...
Bravo = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
Bravo.set_position(85, 120)
controller.move_sprite(Bravo)
info.set_life(3)
Bravo.set_stay_in_screen(True)
Charli = sprites.create(img("""
    ...
    """),
    SpriteKind.enemy)
Charli.set_position(138, 105)
Charli.say_text("Buuuh")
Delta = sprites.create(img("""
    ...
    """),
    SpriteKind.Friend)
Delta.set_position(21, 31)
Delta.say_text("Buuuh")
cibo = sprites.create(img("""
    ...
    """),
    SpriteKind.food)
cibo.set_position(92, 40)
Charli.set_flag(SpriteFlag.GHOST, True)
Delta.set_flag(SpriteFlag.GHOST, True)
