...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    Charli.setFlag(SpriteFlag.Ghost, false)
    Delta.setFlag(SpriteFlag.Ghost, false)
    cibo.setPosition(0, 0)
...
let Bravo = sprites.create(img`
    ...
    ........................
    `, SpriteKind.Player)
Bravo.setPosition(85, 120)
controller.moveSprite(Bravo)
info.setLife(3)
Bravo.setStayInScreen(true)
Charli = sprites.create(img`
    ...
    ........................
    `, SpriteKind.Enemy)
Charli.setPosition(138, 105)
Charli.sayText("Buuuh")
Delta = sprites.create(img`
    ........................
    ........................
    ........................
    ........................
...
cibo = sprites.create(img`
    ...
    . . . . . 2 2 e e e e . . . . . 
    `, SpriteKind.Food)
cibo.setPosition(92, 40)
Charli.setFlag(SpriteFlag.Ghost, true)
Delta.setFlag(SpriteFlag.Ghost, true)
forever(function () {
...
forever(function () {
    Delta.setVelocity(0, 100)
    pause(750)
    Delta.setVelocity(0, -100)
    pause(750)
})
forever(function () {
    Charli.setVelocity(0, -100)
    pause(750)
    Charli.setVelocity(0, 100)
    pause(750)
})
